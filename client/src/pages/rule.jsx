                ...
                <div className='hell'>
                    <div className='box'>
                        ...
                        <ul>
                            ...
                            <li><span className='sno'>4 </span> <span>Player BGMI ID must bu 40 or above Level </span></li>
                            <li><span className='sno'>5 </span> <span>If Any Player Not abailable on Given slot, opponent Will Qualify </span></li>
                        </ul>
